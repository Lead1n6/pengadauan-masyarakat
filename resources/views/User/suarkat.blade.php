  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('user.landing')}}">Laporan</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="jumbotron text-center mb-3 p-5" style="background-color: #D1DBFF;">
  ...
  <h1 class="display-4" style="font-family: Times New Roman">SELAMAT DATANG DI LAYANAN PENGADUAN MASYARAKAT</h1>
  <p class="lead">Hal terpenting dalam mengelola pengaduan masyarakat adalah kecepatannya dalam merespons dan menindaklanjuti suatu pengaduan</p>
...
<section id="prosedur" style="background-color: #D1DBFF;">
    <div class="container" style="padding-top: 5rem;">
        <div class="row text-center mb-3">
             <div class="col-">
             <h2 style="font-family: Times New Roman"><b>Prosedur</b></h2>
             <p class="lead">Berikut prosedur pengaduan masyarakat</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6 mb-3 mb-sm-0">
